// The association's seal, ghosted behind the hero copy and turning slowly on
// its vertical axis like a coin on a table. Centered on the copy column (the
// `relative` wrapper around it in Home.tsx). Screened onto the navy at 8% so
