...
export const programs: Program[] = [
  ...
  { name: "Ridge Technical College", city: "Winter Haven", lat: 28.022, lon: -81.733, url: "https://ridge.edu" },
  ...
  { name: "Coral Springs Regional Institute of Public Safety", city: "Coral Springs", lat: 26.271, lon: -80.271, url: "https://csrips.org" },
