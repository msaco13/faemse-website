        ...
        <div className="wrap">
          <ul className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-5 list-none p-0 m-0">
            {sponsors.map((s) => (
              <li
                key={s.name}
                className="card p-5 grid place-items-center min-h-[120px] text-center hover:border-brand-gold/60 hover:shadow-[0_18px_50px_rgba(177,133,22,.16)] hover:-translate-y-1 transition-all"
              >
                {s.logo ? (
                  <img
