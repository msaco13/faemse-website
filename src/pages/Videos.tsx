...
//
// The board has parked production until instructors are lined up, so until
// the first video is posted this page shows an honest in-development state
// rather than placeholder titles.

const tracks = [
  {
    name: 'Skills lab',
    text: 'Running a station so the slow learner and the fast one both leave better — megacode, airway, trauma.',
  },
  {
    name: 'Classroom',
    text: 'Writing exam items that predict NREMT performance, pacing a hard lecture, teaching pharmacology that sticks.',
  },
  {
    name: 'Clinical & field',
    text: 'Coaching preceptors to actually teach, structuring rotations, and turning a bad shift into a good debrief.',
  },
];
...
export default function Videos() {
  ...
  const inDevelopment = loaded && items.length === 0;
